...
def _f(function):
    return _p.createFunction(function, _p.PLATFORM.GLES2, 'GLES2_NV_draw_vulkan_image',
                             error_checker=_errors._error_checker)


@_f
@_p.types(None, _cs.GLuint64, _cs.GLuint, _cs.GLfloat, _cs.GLfloat, _cs.GLfloat, _cs.GLfloat, _cs.GLfloat, _cs.GLfloat,
          _cs.GLfloat, _cs.GLfloat, _cs.GLfloat)

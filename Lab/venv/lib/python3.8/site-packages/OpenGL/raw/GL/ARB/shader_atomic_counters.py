...
def _f(function):
    return _p.createFunction(function, _p.PLATFORM.GL, 'GL_ARB_shader_atomic_counters',
...
GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES = _C('GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES',
                                                            0x92C6)

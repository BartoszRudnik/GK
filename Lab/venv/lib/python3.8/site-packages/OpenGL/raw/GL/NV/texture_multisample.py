...
def _f(function):
    return _p.createFunction(function, _p.PLATFORM.GL, 'GL_NV_texture_multisample',
...
def glTexImage2DMultisampleCoverageNV(target, coverageSamples, colorSamples, internalFormat, width, height,
                                      fixedSampleLocations): pass
